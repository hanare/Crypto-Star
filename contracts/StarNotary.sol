...
contract StarNotary is ERC721 {
    ...
    string public constant name="Cryto Star";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        //string  memory starSearch =tokenIdToStarInfo[_tokenId].name;        
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You can't transer a Star you don't owned");
